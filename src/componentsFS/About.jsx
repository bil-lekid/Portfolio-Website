      ...
      <div className="w-full h-screen bg-[#0a192f] text-gray-300 flex flex-col justify-center pt-20 md:pt-0">
        ...
        >
          <div className="flex justify-center gap-8 items-center ">
            ...
            <img
              className="h-[72px] md:h-[172px] rounded-full border-4 border-pink-600 m-1 bg-white"
              src="https://cdn.icon-icons.com/icons2/510/PNG/512/university_icon-icons.com_49967.png"
              alt="hitni_dota"
            />
          </div>
