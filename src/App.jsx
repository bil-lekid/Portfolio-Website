...
const Home = () => {
  ...
  return (
    <div className="bg-[#0a192f] w-full h-screen flex flex-col justify-center items-center">
      <img
        className="h-96 w-96 rounded-full object-cover border-4 border-pink-600 mb-10"
        src={Portrait}
        alt="billy"
      />
      <div
        className="w-full grid grid-cols-3 gap-2 justify-stretch px-3 text-xl md:text-2xl"
        data-aos="flip-right"
      >
        <button
          onClick={() => navigate("/data-scientist")}
