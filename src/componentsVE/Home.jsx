      ...
      >
        ...
        <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center items-center h-full">
          ...
          <p className="text-[15px] sm:text-xl text-gray-200 py-4  text-justify max-w-[806px]">
            A passionate Video Editor and Content Creator from Indonesia,
            Jakarta. Never shy of utilizing new technologies and non-stop
            improvement. Creator of two YouTube channels:
          </p>
          <div className="flex lg:hidden justify-center ">
            <a href="https://www.youtube.com/@hitni_dota">
              <img
                className="w-32 sm:w-48 rounded-full mr-4 sm:mr-8 hover:opacity-70 border-4 border-pink-600"
            ...
            <a href="https://www.youtube.com/@DBHobbyTV">
              <img
                className="w-32 sm:w-48 rounded-full hover:opacity-70 border-4 border-pink-600 ml-4 sm:ml-8"
        ...
        <div className="hidden lg:flex flex-col justify-center mr-8 shrink-0">
          <a id="hitniIcon" href="https://www.youtube.com/@hitni_dota">
            <img
