    ...
    >
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center items-center h-full">
        ...
        <p className="text-[15px] sm:text-xl text-gray-200 py-4  text-justify max-w-[806px]">
          A passionate Video Editor and Content Creator from Indonesia, Jakarta.
          Never shy of utilizing new technologies and non-stop improvement.
          Creator of two YouTube channels:
        </p>
