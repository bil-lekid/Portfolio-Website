...
const Navbar = ({ animation }) => {
  ...
  return (
    <div
      data-aos={animation}
      className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300 z-50"
    >
      <div>
      ...
      {/* social icons */}
      <div className="hidden xl:flex fixed flex-col top-[30vh] left-0">
        <ul>
